...
},{"jquery":"../../node_modules/jquery/dist/jquery.js"}],"theme.js":[function(require,module,exports) {
"use strict";
...
(0, _jquery.default)(document).ready(function () {
  ...
  if (isTouchDevice) {
    (0, _jquery.default)("body").removeClass("no-touch");
    (0, _jquery.default)("body").addClass("touch");
  ...
  if (browser.name === "Internet Explorer" && browser.version == "11.0") {
    (0, _jquery.default)("body").addClass("ie-11");
  } else if (browser.name === "Safari") {
    (0, _jquery.default)("body").addClass("safari");
  } // Menu functions


  (0, _jquery.default)(".menu-icon").on("click", function () {
    (0, _jquery.default)("html").toggleClass("locked");
    (0, _jquery.default)("body").toggleClass("locked masked");
    (0, _jquery.default)(this).toggleClass("active");
    (0, _jquery.default)(".nav--mobile").slideToggle();
  });
  (0, _jquery.default)(window).on("resize", function () {
    if ((0, _jquery.default)(window).width() > 1024) {
      (0, _jquery.default)("html").removeClass("locked");
      (0, _jquery.default)("body").removeClass("locked masked");
      (0, _jquery.default)(".menu-icon").removeClass("active");
      (0, _jquery.default)(".nav--mobile").slideUp();
    }
  }); // Mobile menu sub-menu toggle

  (0, _jquery.default)(".nav--mobile .menu-item-has-children > a").on("click", function (e) {
    e.preventDefault();
    (0, _jquery.default)(this).siblings(".sub-menu").slideToggle();
    (0, _jquery.default)(this).toggleClass("active");
  }); // Form Label Animation

  (0, _jquery.default)(".gform_wrapper form .animated").find("input, select, textarea").on("focusin", function () {
    (0, _jquery.default)(this).parents(".animated").children("label").addClass("active-position active-weight active-color"); // Off focus

    (0, _jquery.default)(".gform_wrapper form .animated").find("input, select, textarea").on("focusout", function () {
      if ((0, _jquery.default)(this).val() !== "") {
        // Remove active weight and keep raised position if input has content
        (0, _jquery.default)(this).parents(".animated").children("label").removeClass("active-weight");
      } else {
        // Else remove both weight and raised position
        (0, _jquery.default)(this).parents(".animated").children("label").removeClass("active-position active-weight active-color");
      }
    });
  }); // Slider section

  (0, _jquery.default)(".slider-section__slider").slick({
    autoplay: false,
    arrows: true,
    dots: false,
    slidesToShow: 3,
...
},{"bowser":"../../node_modules/bowser/es5.js","jquery":"../../node_modules/jquery/dist/jquery.js","slick-carousel":"../../node_modules/slick-carousel/slick/slick.js"}]},{},["theme.js"], null)
